                ...
                for (let j = 0; j < RepeatColumns; j++)
                    {
                        ...
                        if (index < numberItems)
                        {
                            ...
                            b.push(
                                <td>
                                    <input id={this.props.model.controlName +'_'+ index} type="checkbox" checked={check} name={this.props.model.controlName} value={this.props.model.selectItems[index].paramNo}
